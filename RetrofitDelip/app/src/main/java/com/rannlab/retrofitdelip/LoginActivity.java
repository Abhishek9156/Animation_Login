package com.rannlab.retrofitdelip;
...
import com.rannlab.retrofitdelip.helper.DatabaseHandler;
import com.rannlab.retrofitdelip.helper.Functions;
import com.rannlab.retrofitdelip.helper.SessionManager;
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        if(Integer.parseInt(json_user.getString("verified")) == 1){
                            db.addUser( json_user.getString(KEY_id_no), json_user.getString(KEY_NAME), json_user.getString(KEY_LAST), json_user.getString(KEY_PHONE), json_user.getString(KEY_EMAIL), json_user.getString(KEY_DOB),json_user.getString(KEY_CITY),json_user.getString(KEY_PINCODE),json_user.getString(KEY_Role) +0);
                            user = db.getUserDetails();
                            session = new SessionManager(getApplicationContext());
